...
/**
 * Yesterday liquid/snow totals from ECCC historical daily bulk (same source as {@link historicalTempPrecip}),
 * aligned to the calendar day before {@link observedAtStation} (matches province grid date labelling).
 */
