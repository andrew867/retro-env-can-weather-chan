...
| Document | Purpose |
|----------|---------|
| [ADR-001-data-plane-and-fork-strategy.md](./ADR-001-data-plane-and-fork-strategy.md) | Fork vs upstream, architecture boundaries |
...
Upstream reference: [Forceh91/retro-env-can-weather-chan](https://github.com/Forceh91/retro-env-can-weather-chan).
